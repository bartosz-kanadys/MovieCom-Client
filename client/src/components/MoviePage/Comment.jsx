        ...
        <div className=' flex'>
            <div className='float-left'>
                <img src="https://t4.ftcdn.net/jpg/04/10/43/77/360_F_410437733_hdq4Q3QOH9uwh0mcqAhRFzOKfrCR24Ta.jpg"
                    className='max-w-32 rounded-lg px-6 pt-6'>
                </img>
                <p className=''>
                    {props.user}
                </p>
            ...
            <div className='bg-app flex items-center justify-center  rounded-lg mt-6 mr-6 ml-3 w-2/12 text-white font-bold text-3xl'>
                {props.rating}/10
            </div>
        </div>
    )
